...
const CardContainer = styled.div`
    ...
    min-height: 4.3em;
    ${tw`
        flex justify-center items-center rounded-md bg-white pt-1 pb-1 pr-2 pl-2 md:pt-2 md:pb-2 md:pl-6 md:pr-6
    `};
`;
...
const Name = styled.span`
    ${tw`
        text-gray-800 text-xs md:text-sm cursor-pointer select-none
    `};
`;
...
const LineSeperator = styled.span`
    ...
    height: 45%;
${tw`
        bg-gray-300 mr-2 ml-2 md:mr-5 md:ml-5
    `};
`;
...
export const BookCard = () => {
    ...
    return <CardContainer>
        ...
        <ItemContainer>
            ...
            {isReturnCalendarOpen && <DateCalender offset value={returnDate} onChange={setReturnDate as any} />}
        </ItemContainer>
